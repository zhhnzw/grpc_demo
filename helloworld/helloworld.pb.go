...
var file_helloworld_helloworld_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xdd, 0x01, 0x0a, 0x0d,
...
var file_helloworld_helloworld_proto_depIdxs = []int32{
	...
	1, // 1: helloworld.SimpleService.SayHello:input_type -> helloworld.HelloRequest
	1, // 2: helloworld.SimpleService.SayHello1:input_type -> helloworld.HelloRequest
	2, // 3: helloworld.SimpleService.SayHello:output_type -> helloworld.HelloReply
	2, // 4: helloworld.SimpleService.SayHello1:output_type -> helloworld.HelloReply
